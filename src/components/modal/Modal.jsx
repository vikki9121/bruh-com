    ...
    <>
      <div className="  text-center rounded-lg text-white font-bold">
        <button
          type="button"
          onClick={openModal}
          className="h-9 w-full rounded-lg text-center font-bold hover:bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-pink-500 to-90% p-1 bg-gray-500"
          style={{ border: '1px solid gray' }}
        >
          <div className=" h-full w-full text-white hover:text-white ">Buy Now</div>
        </button>
      </div>
